...
function arroba_update(){
  ...
  for($i = 1; $i <= count($arroba_sheet)-1; $i++){
    ...
    echo "Arroba ◘◘".$a_ar."<strong> // </strong>".$b_ar."<strong> // </strong>".$c_ar."<strong> // </strong>".$d_ar."<strong> // </strong>".$e_ar."<strong> // </strong>".$f_ar."<strong> // </strong>".$g_ar."<strong> // </strong>".$h_ar_tigf."<strong> // </strong>".$stock_get_a."<br/>";
    echo "===========================================================================================================================================================================<br/>";
    return $status = 1;
  }
}
...
function fastek_update(){
  ...
  for($i = 1; $i <= count($fastek_sheet); $i++){
    ...
    echo "Fastek ◘◘".$a_fa."<strong> // </strong>".$b_fa."<strong> // </strong>".$d_fa."<strong> // </strong>".$c_fa."<strong> // </strong>".$e_fa_tigf."<strong> // </strong>".$stock_get_b."<br/>";
    echo "===========================================================================================================================================================================<br/>";
    return $status = 1;
  }
}
...
function ideac_update(){
  ...
  for($i = 1; $i <= count($ideac_sheet); $i++){
    ...
    $stock_get_c = $f_id;
    #$stock_put = $db->query('UPDATE ps_stock_available SET quantity = "'.$stock_get_c.'" WHERE id_product = "'.$conslt_pe['id_product'].'"');
    echo "Ideac ◘◘".$a_id."<strong> // </strong>".$b_id."<strong> // </strong>".$d_id."<strong> // </strong>".$c_id."<strong> // </strong>".round(number_format($g_id_tigf, 2), PHP_ROUND_HALF_UP)."<strong> // </strong>".$stock_get_c."<br/>";
    echo "===========================================================================================================================================================================<br/>";
    return $status = 1;
  }
}
...
function importacion_update(){
  ...
  for($i = 1; $i <= count($importacion_sheet); $i++){
    ...
    echo "Importacion ◘◘".$b_im."<strong> // </strong>".$a_im."<strong> // </strong>".$c_im."<strong> // </strong>".$d_im."<strong> // </strong>".$e_im_tigf."<strong> // </strong>".$stock_get_d."<br/>";
    echo "===========================================================================================================================================================================<br/>";
    return $status = 1;
  }
}
...
function techsmart_update(){
  ...
  for($i = 1; $i <= count($techsmart->item)-1; $i++){
    ...
    echo "techsmart ◘◘ ".$a_te."<strong> // </strong>".$b_te."<strong> // </strong>".$c_te."<strong> // </strong>".$f_te."<strong> // </strong>".$e_te_tigf."<strong> // </strong>".$stock_get_e."<br/>";
    echo "===========================================================================================================================================================================<br/>";
    return $status = 1;
  }
}
