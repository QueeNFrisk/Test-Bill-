...
<html lang="ja">
  <head>
    ...
    <script src="https://nostalgic-css.github.io/NES.css/lib/vue.min.js"></script>

    <script src="https://nostalgic-css.github.io/NES.css/lib/dialog-polyfill.js"></script>
    <script src="https://nostalgic-css.github.io/NES.css/lib/highlight.js"></script>
            ...
            <section class="coreteam-emeriti" v-if="emeriti.length > 0">
              ...
              <div class="coreteam-members">
                <template v-for="member in emeriti">
                  <section class="nes-container is-dark member-card">
                    <div class="avatar">
                      <img class="lazy" :data-src="assets/providers/arroba.png" :alt="'Emeriti ' + member.name">
                    </div>
                    <div class="profile">
                      <h4 class="name">{{ member.name }}</h4>
                      <p>{{ member.feat }}</p>
  ...
  <script src="https://nostalgic-css.github.io/NES.css/script.js"></script>
  <script>
    const h = document.querySelector('head');
    ['https://nostalgic-css.github.io/NES.css/lib/dialog-polyfill.css', '.https://nostalgic-css.github.io/NES.css/lib/highlight-theme.css'].forEach(a => {
