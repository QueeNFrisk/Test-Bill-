...
semantic.ready = function() {
  ...
  $.extend($.fn.api.settings.api, {
    categorySearch     : 'https://api.semantic-ui.com/search/category/{query}',
    getOverrides       : 'https://semantic-ui.com/src/themes/{$theme}/{$type}s/{$element}.overrides',
    getVariables       : 'https://api.semantic-ui.com/src/themes/{$theme}/{$type}s/{$element}.variables',
    search             : 'https://api.semantic-ui.com/api.semantic-ui.com/search/{query}'
  });
