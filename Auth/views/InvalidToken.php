...
<div class="main center aligned ui container">
  <div class="ui center aligned small basic test modal">
    <div class="ui center aligned icon header">
      ...
      ¡Ah ocurrido un error con el código de activación!
    </div>
    <div class="ui right aligned content">
      <p class="erroreinv">El codigo de activación ha expirado, te hemos enviado nuevamente un correo electronico con un otro código, porfavor confirmalo a su brevedad.</p>
    </div>
