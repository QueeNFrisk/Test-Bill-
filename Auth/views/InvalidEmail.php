...
<div class="main center aligned ui container">
  <div class="ui center aligned small basic test modal">
    <div class="ui center aligned icon header">
      ...
      ¡Ah ocurrido un error con la verificación de tu correo electronico!
    </div>
    <div class="ui right aligned content">
      <p class="erroreinv">Te hemos enviado un correo electronico con el enlace para activar tu cuenta y que puedas hacer uso del servicio.</p>
    </div>
